exports.glyphs['n'] =
	...
	anchors:
		0:
			x: contours[0].nodes[0].expandedTo[0].x + ( contours[1].nodes[3].expandedTo[1].x - contours[0].nodes[0].expandedTo[0].x ) * 0.5
			y: xHeight + diacriticHeight
		1: # n cedilla
			x: contours[0].nodes[0].expandedTo[0].x + ( contours[1].nodes[3].expandedTo[1].x - contours[0].nodes[0].expandedTo[0].x ) * 0.5
			y: - diacriticHeight
		2: # ŋ component
			x: contours[1].nodes[3].expandedTo[0].x + ( contours[1].nodes[3].expandedTo[1].x - contours[1].nodes[3].expandedTo[0].x ) * 0.5
			y: 0
	contours:
		0:
			skeleton: true
